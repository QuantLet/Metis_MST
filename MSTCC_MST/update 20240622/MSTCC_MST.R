...
for (t in 1 : length(mst)){
  ...
  centered_layout[(centered_layout[, 1])<0, 1] <- centered_layout[(centered_layout[, 1])<0, 1] / x_range[2] * desired_range[2]
  centered_layout[(centered_layout[, 1])>0, 2] <- centered_layout[(centered_layout[, 1])>0, 2] / y_range[2] * desired_range[2]
  centered_layout[(centered_layout[, 1])<0, 2] <- centered_layout[(centered_layout[, 1])<0, 2] / y_range[2] * desired_range[2]
  
  # centered_layout[, 1] <- centered_layout[, 1] / diff(x_range) * diff(desired_range)
  # centered_layout[, 2] <- centered_layout[, 2] / diff(y_range) * diff(desired_range)
